...
test "multiple blocks" {
    ...
    try testBlock("\xb3Hello there\x06\x00\xf0\x12I am a sentence to be compressed.", "Hello there there I am a sentence to be compressed.");

    // Go back 6 and copy (4 + 3) bytes
    // Go back 17 and copy 18 bytes.
    try testBlock("\xb3Hello there\x06\x00\xf8\x11I am a sentence to be compressed\x11\x00\x50essed", "Hello there there I am a sentence to be compressed to be compressed");
